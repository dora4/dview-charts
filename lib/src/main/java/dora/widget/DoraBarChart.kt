...
import dora.widget.chart.BaseAxisChartView
import dora.widget.chart.animation.ChartAnimator
import dora.widget.chart.animation.ChartAnimator.Companion.ANIMATOR_TIME
...
class DoraBarChart @JvmOverloads constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int = 0)
    : BaseAxisChartView<BarEntry, BarDataset, BarData>(context, attrs, defStyleAttr) {

    override fun createDataRenderer(): DataRenderer {

        var phaseY = 1f

        return object : DataRenderer(ChartAnimator {
