...
import dora.widget.chart.renderer.AxisRenderer
import kotlin.math.abs

abstract class BaseAxisChartView<E : BaseChartEntry, S : BaseChartDataSet<E>,
        T : BaseChartData<E, S>>
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
                          defStyleAttr: Int = 0) : BaseChartView<E, S, T>(context,
        attrs, defStyleAttr) {

    var xAxis: XAxis<E, S> = XAxis()
    var yAxis: YAxis<E, S> = YAxis()
    ...
    lateinit var axisRenderer: AxisRenderer<E, S>

    override fun init() {
        super.init()
        axisRenderer = object : AxisRenderer<E, S>(ChartAnimator {}) {
            override fun drawXAxis(xAxis: XAxis<E, S>, canvas: Canvas) {
            ...
            override fun drawYAxis(yAxis: YAxis<E, S>, canvas: Canvas) {
            ...
            override fun drawGridLine(xAxis: XAxis<E, S>, canvas: Canvas) {
            ...
            override fun drawGridLine(yAxis: YAxis<E, S>, canvas: Canvas) {
            }
            ...
            override fun drawXAxisScaleValue(xAxis: XAxis<E, S>, canvas: Canvas) {
            }

            override fun drawYAxisScaleValue(yAxis: YAxis<E, S>, canvas: Canvas) {
